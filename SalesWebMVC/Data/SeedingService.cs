...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public SeedingService(SalesWebMVCContext context) // quando um seedingservice for criado, vai receber uma instância do context
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            // adicionando os objetos no banco
            ...
            _context.SaveChanges(); // salva e confirma as alterações
        }
    }
}
